...
public class TruckManagement_newPanel extends JPanel {
	...
	public TruckManagement_newPanel(IntermediateMainController c,
			IntermediateFrame f) {
		this.controller = c;
		this.frame = f;
		...
		train_ID = new JLabel("汽车编号");
		train_destination = new JLabel("汽车目的地");
		train_farePrice = new JLabel("汽车租金（/个）");
