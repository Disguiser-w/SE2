...
//  										   仓库编号                    最多多少排     最多多少架          最多多少位         警戒比例
	public int enterRepertory(String JJD_ID, int blockNum, String date) throws RemoteException;
...
//                                   3 机动区;
	...
	public int leaveRepertory(String JJD_ID, String date) throws RemoteException;
//                               仓库编号                          寄件单号       出库日期
