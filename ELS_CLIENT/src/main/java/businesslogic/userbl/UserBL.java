...
public class UserBL implements UserBLService {
	...
	public LogVO login(String userName, String password) {
		try {
			ArrayList<UserPO> userList = udService.findUserByKeyword(userName);
			if (userList == null) // 找不到该用户，返回2
	 ...
	 * user:userList0) System.out.println("ID: "+user.getID()+", Name: "
	 * +user.getName()+", Profession: "+user.getProfession()+", Organization: "
	 * +user.getOrganization()+", SalaryPlan: "+user.getSalaryPlan()+
	 * ", Authority: "+user.getAuthority()+", Grades: "+user.getGrades());
	 * 
	 ...
	 * user:userList1) System.out.println("ID: "+user.getID()+", Name: "
	 * +user.getName()+", Profession: "+user.getProfession()+", Organization: "
	 * +user.getOrganization()+", SalaryPlan: "+user.getSalaryPlan()+
	 * ", Authority: "+user.getAuthority()+", Grades: "+user.getGrades());
	 * 
