...
public class CheckBusinessPanel extends OperationPanel {
	...
	public void confirmui(){
		...
		if(beginDate.equals("")||endDate.equals("")){
			...
			JOptionPane.showOptionDialog(null, "制表人员王腻腻说，开始日期晚于结束日期，你看着她的眼睛再选一遍", "恭喜恭喜，你触发了我设置的大礼包", WHEN_FOCUSED, WHEN_FOCUSED, ImageGetter.getImage("CW.png"), options, options[0]);
			//JOptionPane.showMessageDialog(null, "制表人员王腻腻说，开始日期晚于结束日期，你看着她的眼睛再选一遍", "提示", JOptionPane.WARNING_MESSAGE, ImageGetter.getImage("CW.png"));
		}
		else{
