...
public class LeaveReceiptDetailedInfoPanel extends OperationPanel{
	...
	private MyTextLabel leaveMessageLabel;
	...
	public LeaveReceiptDetailedInfoPanel(RepertoryFrame repertoryFrame, LeaveRepertoryReceiptController leaveRepertoryReceiptController, String leaveReceiptID){
		...
		leaveMessageLabel = new MyTextLabel("详细出库信息");

		receiptIDField = new MyTextField();
		receiptIDField.setText(leaveReceiptID);
	...
	public void setBounds(int x, int y, int width, int height) {
		...
		stateLabel.setBounds((int) (width * 6.880921895006402 / 25), (int) (height * 8.0035714285714284 / 20),
				(int) (width * 5.649167733674776 / 25), (int) (height * 1.2053571428571428 / 20));
		leaveMessageLabel.setBounds((int) (width * 3.880921895006402 / 25), (int) (height * 9.5035714285714284 / 20),
				(int) (width * 5.649167733674776 / 25), (int) (height * 1.2053571428571428 / 20));
