	...
	private void addListener() {
		...
		modifyLabel.addMouseListener(new MouseAdapter() {
			public void mouseClicked(MouseEvent e) {
				...
				DriverVO vo = drivers.get(selectedIndex.get(0));
...
//
// public DriverManagerPanel(DriverManagerController controller, UserFrame
// mainFrame) {
// this.mainFrame = mainFrame;
// this.controller = controller;
// addLabel = new JLabel("增");
...
// public void setBounds(int x, int y, int width, int height) {
// super.setBounds(x, y, width, height);
// numOfPage.setBounds((int) (width * 12.32394366197183 / 25), (int) (height *
// 17.321428571428573 / 20),
// (int) (width * 1.088348271446863 / 25), (int) (height * 1.4732142857142858 /
// 20));
// selectDriver.get(0).setBounds((int) (width * 0.2560819462227913 / 25), (int)
// (height * 5.625 / 20),
// (int) (width * 0.6722151088348272 / 25), (int) (height * 0.8035714285714286 /
// 20));
// selectDriver.get(1).setBounds((int) (width * 0.2560819462227913 / 25), (int)
// (height * 6.830357142857143 / 20),
// (int) (width * 0.6402048655569782 / 25), (int) (height * 0.8928571428571429 /
// 20));
// selectDriver.get(2).setBounds((int) (width * 0.2560819462227913 / 25), (int)
// (height * 8.125 / 20),
// (int) (width * 0.6402048655569782 / 25), (int) (height * 0.8928571428571429 /
// 20));
// selectDriver.get(3).setBounds((int) (width * 0.2560819462227913 / 25), (int)
// (height * 9.419642857142858 / 20),
// (int) (width * 0.6402048655569782 / 25), (int) (height * 0.8928571428571429 /
// 20));
// selectDriver.get(4).setBounds((int) (width * 0.2560819462227913 / 25), (int)
// (height * 10.758928571428571 / 20),
// (int) (width * 0.6402048655569782 / 25), (int) (height * 0.8928571428571429 /
// 20));
// selectDriver.get(5).setBounds((int) (width * 0.2560819462227913 / 25), (int)
// (height * 12.098214285714286 / 20),
// (int) (width * 0.6402048655569782 / 25), (int) (height * 0.8928571428571429 /
// 20));
// selectDriver.get(6).setBounds((int) (width * 0.2560819462227913 / 25), (int)
// (height * 13.348214285714286 / 20),
// (int) (width * 0.6402048655569782 / 25), (int) (height * 0.8928571428571429 /
// 20));
// selectDriver.get(7).setBounds((int) (width * 0.2560819462227913 / 25), (int)
// (height * 14.642857142857142 / 20),
// (int) (width * 0.6402048655569782 / 25), (int) (height * 0.8928571428571429 /
// 20));
// addLabel.setBounds((int) (width * 2.624839948783611 / 25), (int) (height *
// 1.1607142857142858 / 20),
// (int) (width * 1.3124199743918055 / 25), (int) (height * 1.8303571428571428 /
// 20));
// delLabel.setBounds((int) (width * 6.594110115236876 / 25), (int) (height *
// 1.1607142857142858 / 20),
// (int) (width * 1.3124199743918055 / 25), (int) (height * 1.8303571428571428 /
// 20));
// modifyLabel.setBounds((int) (width * 10.56338028169014 / 25), (int) (height *
// 1.1607142857142858 / 20),
// (int) (width * 1.3124199743918055 / 25), (int) (height * 1.8303571428571428 /
// 20));
// searchLabel.setBounds((int) (width * 15.781049935979514 / 25), (int) (height
// * 1.3392857142857142 / 20),
// (int) (width * 0.9282970550576184 / 25), (int) (height * 1.2946428571428572 /
// 20));
// inputField.setBounds((int) (width * 16.677336747759284 / 25), (int) (height *
// 1.3392857142857142 / 20),
// (int) (width * 4.321382842509603 / 25), (int) (height * 1.3392857142857142 /
// 20));
// confirmButton.setBounds((int) (width * 22.247119078104994 / 25), (int)
// (height * 1.3392857142857142 / 20),
// (int) (width * 1.7285531370038412 / 25), (int) (height * 1.2946428571428572 /
// 20));
// messageTable.setBounds((int) (width * 1.0243277848911652 / 25), (int) (height
// * 5.401785714285714 / 20),
// (int) (width * 22.98335467349552 / 25), (int) (height * 10.535714285714286 /
// 20));
// messageTable.getTableHeader().setBounds((int) (width * 1.0243277848911652 /
// 25),
// (int) (height * 5.401785714285714 / 20) - (int) (height * 1.435714285714286 /
// 20),
// (int) (width * 22.98335467349552 / 25), (int) (height * 1.435714285714286 /
// 20));
// previousPageLabel.setBounds((int) (width * 11.331626120358514 / 25), (int)
// (height * 17.321428571428573 / 20),
// (int) (width * 1.0243277848911652 / 25), (int) (height * 1.4732142857142858 /
// 20));
// nextPageLabel.setBounds((int) (width * 13.380281690140846 / 25), (int)
// (height * 17.321428571428573 / 20),
// (int) (width * 1.0243277848911652 / 25), (int) (height * 1.4732142857142858 /
// 20));
// setInfos();
...
// column1.setPreferredWidth(tWidth * 5 / 32);110,88,198,176,66,66
// column2.setPreferredWidth(tWidth * 4 / 32);
// column3.setPreferredWidth(tWidth * 9 / 32);
// column4.setPreferredWidth(tWidth * 8 / 32);
...
// super.setBounds(x, y, width, height);
//
// idLabel.setBounds((int) (width * 6.818181818181818 / 25), (int) (height *
// 1.4285714285714286 / 20),
// (int) (width * 3.329065300896287 / 25), (int) (height * 1.2053571428571428 /
// 20));
// idField.setBounds((int) (width * 12.580025608194623 / 25), (int) (height *
// 1.4285714285714286 / 20),
// (int) (width * 5.409731113956466 / 25), (int) (height * 1.25 / 20));
// nameLabel.setBounds((int) (width * 6.818181818181818 / 25), (int) (height *
// 3.080357142857143 / 20),
// (int) (width * 3.329065300896287 / 25), (int) (height * 1.2053571428571428 /
// 20));
// nameField.setBounds((int) (width * 12.580025608194623 / 25), (int) (height *
// 3.080357142857143 / 20),
// (int) (width * 5.409731113956466 / 25), (int) (height * 1.25 / 20));
// birthLabel.setBounds((int) (width * 6.818181818181818 / 25), (int) (height *
// 4.776785714285714 / 20),
// (int) (width * 3.329065300896287 / 25), (int) (height * 1.2053571428571428 /
// 20));
// month.setBounds((int) (width * 14.788732394366198 / 25), (int) (height *
// 4.776785714285714 / 20),
// (int) (width * 1.440460947503201 / 25), (int) (height * 1.2053571428571428 /
// 20));
// gap1.setBounds((int) (width * 16.229193341869397 / 25), (int) (height *
// 4.776785714285714 / 20),
// (int) (width * 0.2880921895006402 / 25), (int) (height * 1.2053571428571428 /
// 20));
// day.setBounds((int) (width * 16.51728553137004 / 25), (int) (height *
// 4.776785714285714 / 20),
// (int) (width * 1.440460947503201 / 25), (int) (height * 1.2053571428571428 /
// 20));
// gap2.setBounds((int) (width * 14.500640204865556 / 25), (int) (height *
// 4.776785714285714 / 20),
// (int) (width * 0.2880921895006402 / 25), (int) (height * 1.2053571428571428 /
// 20));
// year.setBounds((int) (width * 12.580025608194623 / 25), (int) (height *
// 4.776785714285714 / 20),
// (int) (width * 1.9206145966709347 / 25), (int) (height * 1.2053571428571428 /
// 20));
// idCardNumLabel.setBounds((int) (width * 6.818181818181818 / 25), (int)
// (height * 6.428571428571429 / 20),
// (int) (width * 3.329065300896287 / 25), (int) (height * 1.2053571428571428 /
// 20));
// idCardNumField.setBounds((int) (width * 12.580025608194623 / 25), (int)
// (height * 6.428571428571429 / 20),
// (int) (width * 5.409731113956466 / 25), (int) (height * 1.25 / 20));
// phoneNumberLabel.setBounds((int) (width * 6.818181818181818 / 25), (int)
// (height * 8.125 / 20),
// (int) (width * 3.329065300896287 / 25), (int) (height * 1.2053571428571428 /
// 20));
// phoneNumberField.setBounds((int) (width * 12.612035851472472 / 25), (int)
// (height * 8.125 / 20),
// (int) (width * 5.409731113956466 / 25), (int) (height * 1.25 / 20));
// registrationDeadlineLabel.setBounds((int) (width * 6.818181818181818 / 25),
// (int) (height * 9.776785714285714 / 20), (int) (width * 3.329065300896287 /
// 25),
// (int) (height * 1.2053571428571428 / 20));
// registrationDeadlineField.setBounds((int) (width * 12.612035851472472 / 25),
// (int) (height * 11.428571428571429 / 20), (int) (width * 5.409731113956466 /
// 25),
// (int) (height * 1.25 / 20));
// timeLabel.setBounds((int) (width * 6.850192061459667 / 25), (int) (height *
// 11.428571428571429 / 20),
// (int) (width * 3.329065300896287 / 25), (int) (height * 1.2053571428571428 /
// 20));
// timeField.setBounds((int) (width * 12.612035851472472 / 25), (int) (height *
// 9.776785714285714 / 20),
// (int) (width * 5.409731113956466 / 25), (int) (height * 1.25 / 20));
// confirmButton.setBounds((int) (width * 7.490396927016645 / 25), (int) (height
// * 16.383928571428573 / 20),
// (int) (width * 2.4007682458386683 / 25), (int) (height * 1.25 / 20));
// cancelButton.setBounds((int) (width * 14.468629961587707 / 25), (int) (height
// * 16.383928571428573 / 20),
// (int) (width * 2.4007682458386683 / 25), (int) (height * 1.25 / 20));
// sexLabel.setBounds((int) (width * 6.850192061459667 / 25), (int) (height *
// 13.080357142857142 / 20),
// (int) (width * 3.329065300896287 / 25), (int) (height * 1.2053571428571428 /
// 20));
// male.setBounds((int) (width * 13.284250960307299 / 25), (int) (height *
// 13.035714285714286 / 20),
// (int) (width * 1.3764404609475032 / 25), (int) (height * 1.3392857142857142 /
// 20));
// female.setBounds((int) (width * 15.685019206145967 / 25), (int) (height *
// 13.035714285714286 / 20),
// (int) (width * 2.848911651728553 / 25), (int) (height * 1.3392857142857142 /
// 20));
// }
//
// private void setInfo1() {
...
// s = Sexuality.FEMALE;
//
// DriverVO modifierVO = new DriverVO(id, newName, date, idNum, mobilePhone,
// oldVO.vehicleOrganization,
// s, ye + "", times);
//
// if (controller.modifyDriver(modifierVO)) {
// successing("成功修改司机信息");
...
// (int) (height * 1.2053571428571428 / 20));
// registrationDeadlineField.setBounds((int) (width * 12.612035851472472 / 25),
// (int) (height * 9.776785714285714 / 20), (int) (width * 5.409731113956466 /
// 25),
// (int) (height * 1.25 / 20));
// timeLabel.setBounds((int) (width * 6.850192061459667 / 25), (int) (height *
// 11.428571428571429 / 20),
...
// }
// return "SJ-" +
// BusinessMainController.businessVO.organizationVO.organizationID + "-" + ID;
// }
// }
//
// public void warnning(String message) {
// // fix 放到底部信息栏
// JOptionPane.showMessageDialog(null, message, "司机信息错误",
