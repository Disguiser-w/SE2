...
public class QueryPanel extends JPanel {
	...
	public void setBounds(int x, int y, int width, int height) {
		...
		timeInputLabel.setBounds(width / 20, height * 2 / 25, width * 2 / 20, height * 2 / 25);
		timeField.setBounds(width / 6, height * 2 / 25, width * 3 / 20, height * 2 / 25);
		timeSetLabel.setBounds(width * 7 / 20 + 5, height * 2 / 25, width * 1 / 20, height * 2 / 25);
		confirmButton.setBounds(width * 2 / 3, height * 2 / 25, width * 1 / 15, height * 2 / 25);
		messageTable.setBounds(width / 20, height * 6 / 25, width * 9 / 10, height * 3 / 5);
		nextPageLabel.setBounds(width * 5 / 6, height * 22 / 25, height * 2 / 25, height * 2 / 25);
		previousPageLabel.setBounds(width * 43 / 48, height * 22 / 25, height * 2 / 25, height * 2 / 25);
