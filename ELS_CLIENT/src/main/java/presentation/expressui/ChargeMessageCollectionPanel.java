...
//		helper = new LocationHelper(this);
	...
	public void setBounds(int x, int y, int width, int height) {
		...
		messageTable.setLocationAndSize((int) (width * 1.0572987721691678 / 25), (int) (height * 1.146953405017921 / 20),
				(int) (width * 22.919508867667123 / 25), (int) (height * 15.770609318996415 / 20));
