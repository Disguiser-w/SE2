...
public class OrganizationData extends UnicastRemoteObject implements OrganizationDataService {
	...
	//
	// // 绑定RMI名称进行发布
	// Naming.rebind("rmi://172.25.132.40:6006/OrganizationDataService",
	// organizationData);
	// System.out.println("Organization Service start!");
	//
	// ArrayList<OrganizationPO> organizationList0 =
	// organizationData.showAllOrganizations();
	// for (OrganizationPO organization : organizationList0)
	// System.out.println("ID: " + organization.getOrganizationID() + ", Name: "
	// + organization.getName());
	//
	// OrganizationPO organizationpo =
	// organizationData.findOrganization("025000");
	// System.out.println("ID: " + organizationpo.getOrganizationID() + ", Name:
